        ...
        <div class="login-wrap">
            <div class="login-left striped-bg text-center">
                <a href="/dcm" class="logo-lg">
                    <i class="fa fa-paper-plane"></i> DCM
                </a>
                <div class="slogan">Dynamic Cost Model</div>
            </div>
            <div class="login-right striped-bg">
                ...
                <div class="input">
                    <form class="form-horizontal" role="form" method="POST" action="auth/register">
                        ...
                        <div class="login-input-group">
                            <span class="login-input-group-addon" id="basic-addon1"><i class="fa fa-map-marker"></i></span>
                            <input type="county" class="here form-control" placeholder="county" aria-describedby="basic-addon1" name="county" value="">
                        </div>
                        <div class="login-input-group">
